...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo URL; ?>/layouts/assets/img/logo2.png">
  ...
  <body>
    <form action="<?php echo URL; ?>/user/login" method="post" class="container-sm w-50 border p-5 position-absolute top-50 start-50 translate-middle bg-dark bg-gradient text-center">
        <div class="container">
            ...
            <img class="mb-4" src="<?php echo URL; ?>/layouts/assets/img/logo2.png" alt="" width="72" height="72">
            <div class="row">
              <div class="col-lg-12">
                <?php 
    ...
    <p class="position-absolute top-100 start-50 translate-middle text-center mt-5">Copyright &copy; 2022<br>Created by Rheana Aini Sachira</p> 
